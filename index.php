    ...
    $faqs = [
      [
            ...
            "risposta" => 
                [
                    "<p>La recente 
                    <a href='https://curia.europa.eu/juris/document/document.jsf?text=&docid=152065&amppageIndex=0&doclang=it&mode=lst&dir=&occ=first&part=1&cid=276332' target='_blank'>
                ...
                ,
                    ...
                    <a href='https://www.google.com/webmasters/tools/legal-removal-request?complaint_type=rtbf&visit_id=637703352095002922-2898210843&hl=it&rd=1' target='_blank'>
        ...
        [
            ...
            [
                ...
                <a href='https://support.google.com/accounts/troubleshooter/10082950?p=country_association&al=Italia&visit_id=637703400306697234-3088767632&rd=2' target='_blank'>
                    Contattaci
                </a>se ritieni che il paese associato al tuo account sia sbagliato.</p>"
            ]    
        ],
        [
...
<body>
    <header>
        <div class="col-left">
            <img src="./googlelogo_clr_74x24px.svg" alt="google logo">
        ...
        <div class="container-main">
            ...
            <?php foreach($faqs as $section){?>
                <ul>
                    <!-- domanda -->
                    <li>
                        <h2><?php echo $section['domanda']?></h2>
                    </li>
                    <!-- risposta -->
                    <li>
                        <?php foreach($section['risposta'] as $paragraph){?>
